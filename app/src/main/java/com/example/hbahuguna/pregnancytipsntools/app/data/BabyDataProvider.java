...
/**
 * Created by himanshu on 9/10/16.
 */
public class BabyDataProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case ITEMS:
                return BabyContract.Items.CONTENT_TYPE;
            case ITEMS__ID:
                return BabyContract.Items.CONTENT_ITEM_TYPE;
            default:
    ...
    private SelectionBuilder buildSelection(Uri uri, int match, SelectionBuilder builder) {
        ...
        switch (match) {
            ...
            case ITEMS__ID: {
                ...
                return builder.table(Tables.ITEMS).where(BabyContract.Items._ID + "=?", _id);
            }
            default: {
                throw new UnsupportedOperationException("Unknown uri: " + uri);
            }
